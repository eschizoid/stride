...
- Junk HR (outside 35–220 bpm) is filtered at analyze time for stream SAMPLES, and applied again at report time to a session's `avg_hr` by the `progress` EF and speed/HR lenses, so sessions with bad straps
