...
Date: 2026-08-17. Status: accepted. Issue: #161. Prerequisite for #138 (event targeting) and #139 (season view); constrains #140 (taper projection).
...
The boundary test, stated once: if the output would change because the athlete's GOAL changed, it is prescription and does not belong in stride. Arithmetic over a stated plan is goal-blind; a taper recommendation is not.
