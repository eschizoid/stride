    ...
    Str.join_with(
        List.join([
            [
                ...
                "",
                "  last 28 days:",
                "    training load: ${fmt0(z.tss)} (${Num.to_str(z.measured_pct)}% measured — rest estimated from HR/RPE; see doctor)",
...
expect
    s = {
        ...
        fatigue_atl: 10.0,
        form_tsb: 10.0,
        last_28d: { tss: 100.0, z1_s: 600i64, z2_s: 0i64, z3_s: 0i64, z4_s: 0i64, z5_s: 0i64, easy_pct: 100i64, moderate_pct: 0i64, hard_pct: 0i64, measured_pct: 100i64 },
