...
expect is_secret("strava_access_token") == Bool.true
expect is_secret("strava_refresh_token") == Bool.true
expect is_secret("strava_client_secret") == Bool.true
expect is_secret("ftp") == Bool.false
expect is_secret("timezone") == Bool.false
expect is_secret("") == Bool.false
